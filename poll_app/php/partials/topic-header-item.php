...
<?php
  ...
  <div class="col mb-5">
    <canvas id="chart" width="400" height="400" data-likes="<?php echo $topic->likes ?>" data-dislikes="<?php echo $topic->dislikes ?>" style="background-color: gray;"></canvas>
  </div>
...
<?php
  ...
  function comment_form($topic) { ?>
    ...
    <div class="container mt-3 px-0">
      <?php if (Auth::isLogin()) : ?>
        <form action="<?php show_url('topic/detail'); ?>" method="POST">
